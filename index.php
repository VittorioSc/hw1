 ...
 <body>
    ...
    <div id="modal-container">
        ...
        <div id ="flex-container">
            ...
            <span class ="flex-item">
                <a class = "links" href = "login.php">About</a>
            </span>
            <span class ="flex-item">
                <a class = "links" href = "login.php">Contact</a>
            </span>
            <div id = "barra">
            </div>
            <div id ="flex-button">
    ...
    <section>
        ...
        <div class = "guitars">
            ...
            <a href="login.php"><img src = "imageshw1/hollow-body.png" class="guitar-img"></a>
        </div>
        <div class = "guitars">
            <h1 class = "guitar-name">Semi-Hollow</h1>
            <a href ="login.php"><img src = "imageshw1/semi-hollow-body.png" class="guitar-img"></a>
        </div>
        <div class = "guitars">
            <h1 class = "guitar-name">Solid bodies</h1>
            <a href ="login.php"><img src = "imageshw1/electric.png" class="guitar-img"></a>
        </div>
        <div class = "guitars">
            <h1 class = "guitar-name">Acoustics</h1>
            <a href = "login.php"><img src = "imageshw1/acoustic.png" class="guitar-img"></a>
        </div>
        </div>
    </section>
    <p id = "advice">LOGIN FOR FULL EXPERIERCE</p>
    <footer>
        ...
        <div class = barra-f></div>
         <div id = "blocco-informazioni">
            ...
            <div class = "colonne">
                ...
                <p class = "colonne-descrizione">
                    <a class = "link-footer" href = "login.php">Hollow Bodies<br><br></a>
                    <a class = "link-footer" href = "login.php">Semi-Hollows<br><br></a>
                    <a class = "link-footer" href = "login.php">Solid Bodies<br><br></a>
                    <a class = "link-footer" href = "login.php">Acoustic<br><br></a>
            </div>
            <div class = "colonne">
                <h1 class = "colonne-titolo">Shop</h1>
                <p class = "colonne-descrizione">
                    <a class = "link-footer" href = "login.php">Accessories<br><br></a>
                </p>
            </div>
            <div class = "colonne">
