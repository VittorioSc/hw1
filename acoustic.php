...
<p class = "gallery">Acoustic Gallery</p>
<div class = "galleria">
        </div>
        ...
        <iframe src="https://www.youtube.com/embed/GjkZfehFPWg" class = "youtube-video" SameSite = None>
        </iframe>
           </div>
      </section>
        ...
        <div class = barra-f></div>
         <div id = "blocco-informazioni">
            ...
            <div class = "colonne">
                ...
                <p class = "colonne-descrizione">
                    <a class = "link-footer" href = "file:///Users/vittorioscarfalloto/Desktop/Homework%20Completo/shop.html">Accessories<br><br></a>
                </p>
            </div>
            <div class = "colonne">
