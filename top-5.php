...
<head>
        <title>(UN)Real Music - Top 5</title>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1" />
        <link href="top5-style.css" rel="stylesheet" type="text/css"/>
        <script src="mobile.js" defer="true"></script>
        <script src="top5.js" defer="true"></script>
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Bebas Neue">
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=IBM Plex Sans">
        <script src="script-galleria.js" defer="true"></script>
    </head>
    <body>
    <nav>
    <div id = "menu">
    ...
    <div id="modal-container">
        ...
        <div id ="flex-container">
            ...
            <span class ="flex-item">
                <a class = "links" href = "https://www.google.it/">About</a>
            </span>
            <span class ="flex-item">
                <a class = "links" href = "https://www.google.it/">Contact</a>
            </span>
            <div id = "barra">
            </div>
            <div id ="flex-button">
    ...
    <h2>top 5 musical genres of the moment</h2>
    <section id = "blocco-top">
